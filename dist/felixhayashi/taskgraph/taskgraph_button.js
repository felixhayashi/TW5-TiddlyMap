  ...
  TaskGraphWidget.prototype.handleButtonConnection = function(event) {
    ...
    if(fromRefHolder && toRefHolder && fromRefHolder.fields.text && toRefHolder.fields.text){
      ...
      if(fromTObj && toTObj) {
        ...
        console.info("User want's to create an edge from \"" +  fromTObj.fields.title + "\" to \"" +  toTObj.fields.title + "\"");
      
        console.debug("setup the tiddlers to ensure they have an id field and a title");
