...
exports.getClass = function(constrObj) {
  ...
  TaskGraphWidget.prototype.checkForViewChanges = function(changedTiddlers) {
    ...
    //~ $tw.taskgraph.fn.console.log("isMapModified");
    //~ $tw.taskgraph.fn.console.log(isMapModified);
    //~ $tw.taskgraph.fn.console.log("isResponsibleForMapModification");
    //~ $tw.taskgraph.fn.console.log(isResponsibleForMapModification);
    //~ $tw.taskgraph.fn.console.log("isMapModifiedFromOutside");
    //~ $tw.taskgraph.fn.console.log(isMapModifiedFromOutside);
