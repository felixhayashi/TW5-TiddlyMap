...
var MapWidget = function (_Widget) {
  ...
  _createClass(MapWidget, [{
    ...
    value: function rebuildGraphData() {
      ...
      var originalMatches = _utils2.default.getMatches(this.view.getNodeFilter('compiled'));
      ...
      var graph = $tm.adapter.getGraph({
        ...
        includeNeighboursOf: this.view.isEnabled("neighbourhood_include_traced_node_neighbours") ? function (tRef) {
    ...
    value: function handleCreateView() {
      ...
      $tm.dialogManager.open('createView', args, function (isConfirmed, outTObj) {
        ...
        if (isClone && _this8.view.isLiveView()) {
    ...
    value: function handleSaveCanvas() {
      ...
      $tm.dialogManager.open('saveCanvas', args, function (isConfirmed, outTObj) {
        ...
        if (action === 'download') {
          _this11.handleDownloadSnapshot(defaultName);
        } else if (action === 'wiki') {
    ...
    value: function handleRemoveElements(_ref3) {
    ...
    value: function handleSetCentralTopic(_ref4) {
      var paramObject = _ref4.paramObject;
